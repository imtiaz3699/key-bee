...
function CreatorTaskTable({ tasks, pagination, setPagination }) {
        ...
        const menu = (
          <Menu style={{ width: "170px" }} className="!text-[#6F767E]">
            <Menu.Item key="1">
              {" "}
              <Link
                to={`${routes.CREATOR_TASK_VIEW}/${record?.key}`}
                path={routes.CREATOR_TASK_VIEW}
...
export default CreatorTaskTable;
